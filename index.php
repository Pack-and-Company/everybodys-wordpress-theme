	...
	<div class="wrapper">
		...
		<div class="container main">
			...
			<div class="footer">
		        ...
		        <strong>Phone:</strong> <?=get_theme_mod('eb_phone_number');?> or <strong>Email: </strong><a href="mailto:<?=get_theme_mod('eb_email_address');?>"><?=get_theme_mod('eb_email_address');?></a><br />
